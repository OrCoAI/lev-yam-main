...
const LevYamI18n = (function () {
  ...
  const translations = {
    he: {
      ...
      why_p2_html: 'רצועת חוף בתולית, מבנה דייגים עתיק, שקט, שלווה, אנשים לבביים — זה רק חלק מהקסם של <strong class="brand-name">לב ים</strong> בכפר הדייגים ג׳יסר א-זרקא.',
    ...
    ar: {
      ...
      why_p2_html: 'شريط شاطئ بِكر، مبنى صيادين عتيق، هدوء، سكينة، وناس بقلوب دافئة — هذا جزء فقط من سحر <strong class="brand-name">ليف يام</strong> في قرية الصيادين بجسر الزرقاء.',
